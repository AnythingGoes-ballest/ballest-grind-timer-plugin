...
- **Settings** (footer **plugins** > **open** > **installed** > Grind Timer > **settings**): show or hide the timer
...
In the game: footer **plugins** > **open** > **browse** > Grind Timer > **install**. Needs the plugin manager host
0.4.0 or newer.
