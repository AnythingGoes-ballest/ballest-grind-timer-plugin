...
- **Time** counts only while a race is running. It keeps counting through checkpoint respawns and stops in menus,
  after the finish and during a restart.
...
- **Settings** (footer **plugins** > **open** > **settings**): show or hide the timer (hidden, it keeps counting), the size of the time and of the restarts line, how dark
